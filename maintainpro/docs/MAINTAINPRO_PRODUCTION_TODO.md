...
| BUILD-002 | P2 | Facility | Schema foundation + facility roles seed | NOT_STARTED | prisma/schema, roles seed | Schema + RBAC tests | Property/Building/Floor/Room models; FACILITY_MANAGER/BUILDING_SUPERVISOR in RoleName. |
