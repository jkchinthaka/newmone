...
| BUILD-006 | P2 | Facility | Issue reporting UI + room selector | NOT_STARTED | cleaning issues UI, facilities hierarchy | Manual UI QA | Room/category fields in issue forms; no WO bridge yet. |
| BUILD-007 | P2 | Facility | QR issue reporting | NOT_STARTED | qr-readiness integration, scan routes | QR helper + manual scan QA | Public scan deferred; security review required. |
