...
run("vendor_tests", npmCmd, [
  ...
  "--",
  "--runInBand",
  "test/vendor-repair-governance.spec.ts",
  "test/vendor-repair-controls.spec.ts",
  "test/work-order-detail-tabs.spec.ts"
], {}, npmShell);
run("test", npmCmd, ["run", "test"], {}, npmShell);
run("build", npmCmd, ["run", "build"], {}, npmShell);
console.log("uat_013_validation=complete");
