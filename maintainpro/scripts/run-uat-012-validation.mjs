...
run("evidence_tests", npmCmd, [
  ...
  "--",
  "--runInBand",
  "test/work-order-evidence-governance.spec.ts",
  "test/work-order-evidence-controls.spec.ts",
  "test/work-order-evidence-storage.spec.ts"
], {}, npmShell);
run("test", npmCmd, ["run", "test"], {}, npmShell);
run("uat_011", npmCmd, ["run", "uat:011:validate"], {}, npmShell);
console.log("uat_012_validation=complete");
