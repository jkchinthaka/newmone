...
run("parts_governance_tests", npmCmd, [
  "run",
  "test",
  "--workspace",
  "@maintainpro/api",
...
run("uat_007", npmCmd, ["run", "uat:007:validate"], {}, npmShell);
run("uat_008", npmCmd, ["run", "uat:008:validate"], {}, npmShell);
console.log("uat_010_validation=complete");
