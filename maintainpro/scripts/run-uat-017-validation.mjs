...
run("uat017_backend_tests", npmCmd, [
  "run",
  "test",
  "--workspace",
  "@maintainpro/api",
  "--",
  "--runInBand",
  "test/health-public-uat017.spec.ts",
  "test/http-exception-database-unavailable.spec.ts",
  "test/work-order-queues-summary.spec.ts",
...
console.log("uat_017_validation=complete");
