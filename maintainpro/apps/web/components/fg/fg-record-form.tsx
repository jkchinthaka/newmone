...
import type { FgField, FgRecordDetail } from "@/lib/fg-types";
    ...
    >
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Completed fields {completeness.answeredItems} of {completeness.totalItems}. Remaining required fields: {remaining}.
        </p>
      </div>
                    ...
                    <div className="mt-3 grid gap-3">
                      {field.children.map((child) => (
                        <FieldControl
                          ...
                          error={fieldErrorsFor({ code: "", message: "", fieldErrors: {} }, child.fieldName)[0]}
...
function FieldControl({
  ...
  return (
    <div>
      ...
      {field.responseType === "YES_NO" || field.responseType === "YES_NO_NA" ? (
        <div className="flex flex-wrap gap-2" role="radiogroup" aria-labelledby={field.fieldName}>
