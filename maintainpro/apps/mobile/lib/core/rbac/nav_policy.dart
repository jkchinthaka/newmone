    ...
    ModuleNavGroup(
      ...
      items: [
        ModuleNavItem(
          ...
          requiredPermissions: const ['compliance.view'],
        ),
        ModuleNavItem(
          id: 'accidents',
          label: 'Accidents',
          route: '/compliance/accidents',
          allowedRoles: NavRoles.merge([
            NavRoles.management,
            NavRoles.compliance,
            NavRoles.admin,
          ]),
          requiredPermissions: const ['accidents.view'],
        ),
        ModuleNavItem(
          id: 'insurance-claims',
          label: 'Insurance Claims',
          route: '/compliance/insurance-claims',
          allowedRoles: NavRoles.merge([
            NavRoles.management,
            NavRoles.compliance,
            NavRoles.admin,
          ]),
          requiredPermissions: const ['insurance_claims.view'],
        ),
        ModuleNavItem(
          id: 'traffic-fines',
          label: 'Traffic Fines',
          route: '/compliance/traffic-fines',
          allowedRoles: NavRoles.merge([
            NavRoles.management,
            NavRoles.compliance,
            NavRoles.admin,
          ...
          requiredPermissions: const ['traffic_fines.view'],
        ),
      ],
    ),
    ModuleNavGroup(
